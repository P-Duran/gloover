...
class Review(dict):
    def __init__(self, review_id: str, product_name: str, text: str, author: str, date: datetime, country: str,
        ...
        self.author = author
        self.domain = domain
        dict.__init__(self, id=review_id, product_name=product_name, text=text, author=author, date=date,
                      country=country,
    ...
    def from_json(cls, json):
        try:
            ...
            date = json['date']
        return cls(json['id'], json['product_name'], json['text'], json['author'], date
                   , json['country'],
